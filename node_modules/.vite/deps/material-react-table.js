...
} from "./chunk-G2U6RL3U.js";
import "./chunk-TTGKUZR6.js";
import "./chunk-EU5J47M3.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-BFL632LT.js";
import {
  useThemeProps
} from "./chunk-K75Z77GZ.js";
...
var DateTimeField = React3.forwardRef(function DateTimeField2(inProps, inRef) {
...
var DateTimePickerTabs = function DateTimePickerTabs2(inProps) {
  ...
  return (0, import_jsx_runtime36.jsxs)(DateTimePickerTabsRoot, {
    ownerState,
    variant: "fullWidth",
    ...
    sx,
    children: [(0, import_jsx_runtime36.jsx)(Tab_default, {
      value: "date",
      "aria-label": translations.dateTableLabel,
      icon: (0, import_jsx_runtime36.jsx)(React4.Fragment, {
        children: dateIcon
      })
    }), (0, import_jsx_runtime36.jsx)(Tab_default, {
      value: "time",
...
var PickersToolbarText = React5.forwardRef(function PickersToolbarText2(inProps, ref) {
  ...
  return (0, import_jsx_runtime37.jsx)(PickersToolbarTextRoot, _extends({
    ref,
...
var PickersToolbarButton = React6.forwardRef(function PickersToolbarButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime38.jsx)(PickersToolbarButtonRoot, _extends({
    variant: "text",
    ref,
    className: clsx_default(classes.root, className),
    ownerState: props
    ...
    children: (0, import_jsx_runtime38.jsx)(PickersToolbarText, {
      align,
  ...
  return (0, import_jsx_runtime39.jsxs)(DateTimePickerToolbarRoot, _extends({
    ...
    children: [(0, import_jsx_runtime39.jsxs)(DateTimePickerToolbarDateContainer, {
      ...
      children: [(0, import_jsx_runtime39.jsxs)(DateTimePickerToolbarTimeDigitsContainer, {
        ...
        ownerState,
        toolbarVariant,
        children: [views.includes("hours") && (0, import_jsx_runtime39.jsxs)(React7.Fragment, {
        ...
        }), views.includes("seconds") && (0, import_jsx_runtime39.jsxs)(React7.Fragment, {
...
function Clock(inProps) {
  ...
  return (0, import_jsx_runtime41.jsxs)(ClockRoot, {
    ...
    children: [(0, import_jsx_runtime41.jsxs)(ClockClock, {
      ...
      }), !isSelectedTimeDisabled && (0, import_jsx_runtime41.jsxs)(React10.Fragment, {
    ...
    }), ampm && ampmInClock && (0, import_jsx_runtime41.jsxs)(React10.Fragment, {
...
var TimeClock = React14.forwardRef(function TimeClock2(inProps, ref) {
  ...
  return (0, import_jsx_runtime44.jsxs)(TimeClockRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
...
var DigitalClock = React15.forwardRef(function DigitalClock2(inProps, ref) {
  ...
  return (0, import_jsx_runtime45.jsx)(DigitalClockRoot, _extends({
    ref: handleRef,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: (0, import_jsx_runtime45.jsx)(DigitalClockList, {
      ref: listRef,
      role: "listbox",
      ...
      children: timeOptions.map((option, index) => {
        ...
        return (0, import_jsx_runtime45.jsx)(ClockItem, _extends({
...
var MultiSectionDigitalClockSection = React16.forwardRef(function MultiSectionDigitalClockSection2(inProps, ref) {
  ...
  return (0, import_jsx_runtime46.jsx)(MultiSectionDigitalClockSectionRoot, _extends({
    ref: handleRef,
    className: clsx_default(classes.root, className),
    ownerState,
    ...
    children: items.map((option, index) => {
      ...
      return (0, import_jsx_runtime46.jsx)(DigitalClockSectionItem, _extends({
...
var MultiSectionDigitalClock = React17.forwardRef(function MultiSectionDigitalClock2(inProps, ref) {
  ...
  return (0, import_jsx_runtime47.jsx)(MultiSectionDigitalClockRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState,
    role: "group"
  }, other, {
    children: viewsToRender.map((timeView) => (0, import_jsx_runtime47.jsx)(MultiSectionDigitalClockSection, {
...
var DesktopDateTimePickerLayout = React18.forwardRef(function DesktopDateTimePickerLayout2(props, ref) {
  var _a;
  const {
    toolbar,
    tabs,
  ...
  return (0, import_jsx_runtime49.jsxs)(PickersLayoutRoot, {
    ref,
    ...
    ownerState,
    children: [orientation === "landscape" ? shortcuts : toolbar, orientation === "landscape" ? toolbar : shortcuts, (0, import_jsx_runtime49.jsxs)(PickersLayoutContentWrapper, {
      className: clsx_default(pickersLayoutClasses.contentWrapper, classes == null ? void 0 : classes.contentWrapper),
      ownerState,
      sx: {
        display: "grid"
      },
      children: [content, tabs, isActionBarVisible && (0, import_jsx_runtime49.jsx)(Divider_default, {
        sx: {
          gridRow: 3,
          gridColumn: "1 / 4"
        }
...
var rendererInterceptor = function RendererInterceptor(props) {
  ...
  return (0, import_jsx_runtime50.jsxs)(React19.Fragment, {
    ...
    })), timeViewsCount > 0 && (0, import_jsx_runtime50.jsxs)(React19.Fragment, {
...
var TimeField = React22.forwardRef(function TimeField2(inProps, inRef) {
  const themeProps = useThemeProps({
    props: inProps,
    name: "MuiTimeField"
  });
  ...
  return (0, import_jsx_runtime52.jsx)(PickerFieldUIContextProvider, {
    slots,
    slotProps,
    inputRef: other.inputRef,
    children: (0, import_jsx_runtime52.jsx)(PickerFieldUI, {
      fieldResponse,
...
var MRT_EditActionButtons = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(Box_default, { onClick: (e) => e.stopPropagation(), sx: (theme) => Object.assign({ display: "flex", gap: "0.75rem" }, parseFromValuesOrFunc(rest === null || rest === void 0 ? void 0 : rest.sx, theme)), children: variant === "icon" ? (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(0, import_jsx_runtime55.jsx)(Tooltip_default, { title: localization.cancel, children: (0, import_jsx_runtime55.jsx)(IconButton_default, { "aria-label": localization.cancel, onClick: handleCancel, children: (0, import_jsx_runtime55.jsx)(CancelIcon, {}) }) }), (isCreating && onCreatingRowSave || isEditing && onEditingRowSave) && (0, import_jsx_runtime55.jsx)(Tooltip_default, { title: localization.save, children: (0, import_jsx_runtime55.jsx)(IconButton_default, { "aria-label": localization.save, color: "info", disabled: isSaving, onClick: handleSubmitRow, children: isSaving ? (0, import_jsx_runtime55.jsx)(CircularProgress_default, { size: 18 }) : (0, import_jsx_runtime55.jsx)(SaveIcon, {}) }) })] }) : (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(0, import_jsx_runtime55.jsx)(Button_default, { onClick: handleCancel, sx: { minWidth: "100px" }, children: localization.cancel }), (0, import_jsx_runtime55.jsxs)(Button_default, { disabled: isSaving, onClick: handleSubmitRow, sx: { minWidth: "100px" }, variant: "contained", children: [isSaving && (0, import_jsx_runtime55.jsx)(CircularProgress_default, { color: "inherit", size: 18 }), localization.save] })] }) });
};
...
var MRT_ActionMenuItem = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsxs)(MenuItem_default, Object.assign({ sx: {
    alignItems: "center",
    justifyContent: "space-between",
    minWidth: "120px",
    my: 0,
    py: "6px"
  }, tabIndex: 0 }, rest, { children: [(0, import_jsx_runtime55.jsxs)(Box_default, { sx: {
    alignItems: "center",
    display: "flex"
  }, children: [(0, import_jsx_runtime55.jsx)(ListItemIcon_default, { children: icon }), label] }), onOpenSubMenu && (0, import_jsx_runtime55.jsx)(IconButton_default, { onClick: onOpenSubMenu, onMouseEnter: onOpenSubMenu, size: "small", sx: { p: 0 }, children: (0, import_jsx_runtime55.jsx)(ArrowRightIcon, {}) })] }));
};
var MRT_RowActionMenu = (_a) => {
  ...
  const menuItems = (0, import_react.useMemo)(() => {
    const items = [];
    const editItem = parseFromValuesOrFunc(enableEditing, row) && ["modal", "row"].includes(editDisplayMode) && (0, import_jsx_runtime55.jsx)(MRT_ActionMenuItem, { icon: (0, import_jsx_runtime55.jsx)(EditIcon, {}), label: localization.edit, onClick: handleEdit, table }, "edit");
    if (editItem)
      items.push(editItem);
  ...
  if (!menuItems.length)
    return null;
  return (0, import_jsx_runtime55.jsx)(Menu_default, Object.assign({ MenuListProps: {
...
var MRT_ToggleRowActionMenuButton = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(import_jsx_runtime55.Fragment, { children: renderRowActions && !showEditActionButtons ? renderRowActions({ cell, row, staticRowIndex, table }) : showEditActionButtons ? (0, import_jsx_runtime55.jsx)(MRT_EditActionButtons, { row, table }) : !renderRowActionMenuItems && parseFromValuesOrFunc(enableEditing, row) && ["modal", "row"].includes(editDisplayMode) ? (0, import_jsx_runtime55.jsx)(Tooltip_default, { placement: "right", title: localization.edit, children: (0, import_jsx_runtime55.jsx)(IconButton_default, Object.assign({ "aria-label": localization.edit, onClick: handleStartEditMode, sx: commonIconButtonStyles }, rest, { children: (0, import_jsx_runtime55.jsx)(EditIcon, {}) })) }) : ((_b = renderRowActionMenuItems === null || renderRowActionMenuItems === void 0 ? void 0 : renderRowActionMenuItems({
    row,
    staticRowIndex,
    table
  })) === null || _b === void 0 ? void 0 : _b.length) ? (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(0, import_jsx_runtime55.jsx)(Tooltip_default, Object.assign({}, getCommonTooltipProps(), { title: localization.rowActions, children: (0, import_jsx_runtime55.jsx)(IconButton_default, Object.assign({ "aria-label": localization.rowActions, onClick: handleOpenRowActionMenu, size: "small", sx: commonIconButtonStyles }, rest, { children: (0, import_jsx_runtime55.jsx)(MoreHorizIcon, {}) })) })), (0, import_jsx_runtime55.jsx)(MRT_RowActionMenu, { anchorEl, handleEdit: handleStartEditMode, row, setAnchorEl, staticRowIndex, table })] }) : null });
};
var getMRT_RowActionsColumnDef = (tableOptions) => {
  return Object.assign({ Cell: ({ cell, row, staticRowIndex, table }) => (0, import_jsx_runtime55.jsx)(MRT_ToggleRowActionMenuButton, { cell, row, staticRowIndex, table }) }, defaultDisplayColumnProps({
    header: "actions",
    id: "mrt-row-actions",
    size: 70,
    tableOptions
...
var MRT_GrabHandleButton = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(Tooltip_default, Object.assign({}, getCommonTooltipProps("top"), { title: (_b = rest === null || rest === void 0 ? void 0 : rest.title) !== null && _b !== void 0 ? _b : localization.move, children: (0, import_jsx_runtime55.jsx)(IconButton_default, Object.assign({ "aria-label": (_c = rest.title) !== null && _c !== void 0 ? _c : localization.move, disableRipple: true, draggable: "true", size: "small" }, rest, { onClick: (e) => {
    var _a2;
    e.stopPropagation();
    ...
    opacity: 1
  }, cursor: "grab", m: "0 -0.1rem", opacity: location === "row" ? 1 : 0.5, p: "2px", transition: "all 150ms ease-in-out" }, parseFromValuesOrFunc(rest === null || rest === void 0 ? void 0 : rest.sx, theme)), title: void 0, children: (0, import_jsx_runtime55.jsx)(DragHandleIcon, {}) })) }));
};
var MRT_TableBodyRowGrabHandle = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(MRT_GrabHandleButton, Object.assign({}, iconButtonProps, { location: "row", onDragEnd: handleDragEnd, onDragStart: handleDragStart, table }));
};
var getMRT_RowDragColumnDef = (tableOptions) => {
  return Object.assign({ Cell: ({ row, rowRef, table }) => (0, import_jsx_runtime55.jsx)(MRT_TableBodyRowGrabHandle, { row, rowRef, table }), grow: false }, defaultDisplayColumnProps({
    header: "move",
    id: "mrt-row-drag",
    size: 60,
    tableOptions
...
var getMRT_RowExpandColumnDef = (tableOptions) => {
  ...
  return Object.assign({ Cell: ({ cell, column, row, staticRowIndex, table }) => {
    ...
    if (groupedColumnMode === "remove" && row.groupingColumnId) {
      return (0, import_jsx_runtime55.jsxs)(Stack_default, { alignItems: "center", flexDirection: "row", gap: "0.25rem", children: [(0, import_jsx_runtime55.jsx)(MRT_ExpandButton, Object.assign({}, expandButtonProps)), (0, import_jsx_runtime55.jsx)(Tooltip_default, Object.assign({}, getCommonTooltipProps("right"), { title: table.getColumn(row.groupingColumnId).columnDef.header, children: (0, import_jsx_runtime55.jsx)("span", { children: row.groupingValue }) })), !!subRowsLength && (0, import_jsx_runtime55.jsxs)("span", { children: ["(", subRowsLength, ")"] })] });
    } else {
      return (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(0, import_jsx_runtime55.jsx)(MRT_ExpandButton, Object.assign({}, expandButtonProps)), (_c = (_b = column.columnDef).GroupedCell) === null || _c === void 0 ? void 0 : _c.call(_b, { cell, column, row, table })] });
    }
  }, Header: enableExpandAll ? ({ table }) => {
    var _a2;
    return (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(0, import_jsx_runtime55.jsx)(MRT_ExpandAllButton, { table }), groupedColumnMode === "remove" && ((_a2 = grouping === null || grouping === void 0 ? void 0 : grouping.map((groupedColumnId) => table.getColumn(groupedColumnId).columnDef.header)) === null || _a2 === void 0 ? void 0 : _a2.join(", "))] });
...
var MRT_TableBodyRowPinButton = (_a) => {
  ...
  if (rowPinningDisplayMode === "top-and-bottom" && !row.getIsPinned()) {
    return (0, import_jsx_runtime55.jsxs)(Box_default, { sx: {
      display: "flex",
      flexDirection: density === "compact" ? "row" : "column"
    }, children: [(0, import_jsx_runtime55.jsx)(MRT_RowPinButton, Object.assign({ pinningPosition: "top" }, rowPinButtonProps)), (0, import_jsx_runtime55.jsx)(MRT_RowPinButton, Object.assign({ pinningPosition: "bottom" }, rowPinButtonProps))] });
  }
  return (0, import_jsx_runtime55.jsx)(MRT_RowPinButton, Object.assign({ pinningPosition: rowPinningDisplayMode === "bottom" ? "bottom" : "top" }, rowPinButtonProps));
};
var getMRT_RowPinningColumnDef = (tableOptions) => {
  return Object.assign({ Cell: ({ row, table }) => (0, import_jsx_runtime55.jsx)(MRT_TableBodyRowPinButton, { row, table }), grow: false }, defaultDisplayColumnProps({
    header: "pin",
    id: "mrt-row-pin",
    size: 60,
    tableOptions
...
var MRT_SelectCheckbox = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(Tooltip_default, Object.assign({}, getCommonTooltipProps(), { title: (_b = checkboxProps === null || checkboxProps === void 0 ? void 0 : checkboxProps.title) !== null && _b !== void 0 ? _b : selectAll ? localization.toggleSelectAll : localization.toggleSelectRow, children: enableMultiRowSelection === false ? (0, import_jsx_runtime55.jsx)(Radio_default, Object.assign({}, commonProps)) : (0, import_jsx_runtime55.jsx)(Checkbox_default, Object.assign({ indeterminate: !isChecked && selectAll ? table.getIsSomeRowsSelected() : (row === null || row === void 0 ? void 0 : row.getIsSomeSelected()) && row.getCanSelectSubRows() }, commonProps)) }));
};
var getMRT_RowSelectColumnDef = (tableOptions) => {
  const { enableMultiRowSelection, enableSelectAll } = tableOptions;
  return Object.assign({ Cell: ({ row, staticRowIndex, table }) => (0, import_jsx_runtime55.jsx)(MRT_SelectCheckbox, { row, staticRowIndex, table }), Header: enableSelectAll && enableMultiRowSelection ? ({ table }) => (0, import_jsx_runtime55.jsx)(MRT_SelectCheckbox, { table }) : void 0, grow: false }, defaultDisplayColumnProps({
    header: "select",
    id: "mrt-row-select",
...
var MRT_TableBodyCellValue = ({ cell, rowRef, staticColumnIndex, staticRowIndex, table }) => {
  ...
  if (enableFilterMatchHighlighting && columnDef.enableFilterMatchHighlighting !== false && String(renderedCellValue) && allowedTypes.includes(typeof renderedCellValue) && (filterValue && allowedTypes.includes(typeof filterValue) && ["autocomplete", "text"].includes(columnDef.filterVariant) || globalFilter && allowedTypes.includes(typeof globalFilter) && column.getCanGlobalFilter())) {
    ...
    if ((chunks === null || chunks === void 0 ? void 0 : chunks.length) > 1 || ((_b = chunks === null || chunks === void 0 ? void 0 : chunks[0]) === null || _b === void 0 ? void 0 : _b.match)) {
      renderedCellValue = (0, import_jsx_runtime55.jsx)("span", { "aria-label": renderedCellValue, role: "note", children: (_c = chunks === null || chunks === void 0 ? void 0 : chunks.map(({ key, match, text: text2 }) => (0, import_jsx_runtime55.jsx)(Box_default, { "aria-hidden": "true", component: "span", sx: match ? {
...
var MRT_EditCellTextField = (_a) => {
  ...
  if (columnDef.Edit) {
    return (0, import_jsx_runtime55.jsx)(import_jsx_runtime55.Fragment, { children: (_b = columnDef.Edit) === null || _b === void 0 ? void 0 : _b.call(columnDef, { cell, column, row, table }) });
  }
  return (0, import_jsx_runtime55.jsx)(TextField_default, Object.assign({ disabled: parseFromValuesOrFunc(columnDef.enableEditing, row) === false, fullWidth: true, inputRef: (inputRef) => {
    if (inputRef) {
    ...
    return (0, import_jsx_runtime55.jsx)(MenuItem_default, { sx: {
      alignItems: "center",
      display: "flex",
      gap: "0.5rem",
      m: 0
...
var MRT_TableBodyCell = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(TableCell_default, Object.assign({ align: theme.direction === "rtl" ? "right" : "left", "data-index": staticColumnIndex, "data-pinned": !!isColumnPinned || void 0, tabIndex: enableKeyboardShortcuts ? 0 : void 0 }, tableCellProps, { onKeyDown: handleKeyDown, onContextMenu: handleContextMenu, onDoubleClick: handleDoubleClick, onDragEnter: handleDragEnter, onDragOver: handleDragOver, sx: (theme2) => Object.assign(Object.assign({ "&:hover": {
    ...
    tableCellProps,
    theme: theme2
  })), draggingBorders), children: (_b = tableCellProps.children) !== null && _b !== void 0 ? _b : (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [cell.getIsPlaceholder() ? (_d = (_c = columnDef.PlaceholderCell) === null || _c === void 0 ? void 0 : _c.call(columnDef, { cell, column, row, table })) !== null && _d !== void 0 ? _d : null : showSkeletons !== false && (isLoading || showSkeletons) ? (0, import_jsx_runtime55.jsx)(Skeleton_default, Object.assign({ animation: "wave", height: 20, width: skeletonWidth }, skeletonProps)) : columnDefType === "display" && (["mrt-row-expand", "mrt-row-numbers", "mrt-row-select"].includes(column.id) || !row.getIsGrouped()) ? (_e = columnDef.Cell) === null || _e === void 0 ? void 0 : _e.call(columnDef, {
    cell,
    column,
    renderedCellValue: cell.renderValue(),
    row,
    ...
    staticRowIndex,
    table
  }) : isCreating || isEditing ? (0, import_jsx_runtime55.jsx)(MRT_EditCellTextField, { cell, table }) : showClickToCopyButton && columnDef.enableClickToCopy !== false ? (0, import_jsx_runtime55.jsx)(MRT_CopyButton, { cell, table, children: (0, import_jsx_runtime55.jsx)(MRT_TableBodyCellValue, Object.assign({}, cellValueProps)) }) : (0, import_jsx_runtime55.jsx)(MRT_TableBodyCellValue, Object.assign({}, cellValueProps)), cell.getIsGrouped() && !columnDef.GroupedCell && (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [" (", (_f = row.subRows) === null || _f === void 0 ? void 0 : _f.length, ")"] })] }) }));
};
...
var MRT_TableDetailPanel = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(TableRow_default, Object.assign({ className: "Mui-TableBodyCell-DetailPanel", "data-index": renderDetailPanel ? staticRowIndex * 2 + 1 : staticRowIndex, ref: (node) => {
    var _a2;
    if (node) {
...
var MRT_TableBodyRow = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(0, import_jsx_runtime55.jsxs)(TableRow_default, Object.assign({ "data-index": renderDetailPanel ? staticRowIndex * 2 : staticRowIndex, "data-pinned": !!isRowPinned || void 0, "data-selected": isRowSelected2 || void 0, onDragEnter: handleDragEnter, onDragOver: handleDragOver, ref: (node) => {
    ...
    return cell ? memoMode === "cells" && cell.column.columnDef.columnDefType === "data" && !draggingColumn && !draggingRow && (editingCell === null || editingCell === void 0 ? void 0 : editingCell.id) !== cell.id && (editingRow === null || editingRow === void 0 ? void 0 : editingRow.id) !== row.id ? (0, import_jsx_runtime55.jsx)(Memo_MRT_TableBodyCell, Object.assign({}, props), key) : (0, import_jsx_runtime55.jsx)(MRT_TableBodyCell, Object.assign({}, props), key) : null;
  }), virtualPaddingRight ? (0, import_jsx_runtime55.jsx)("td", { style: { display: "flex", width: virtualPaddingRight } }) : null] })), renderDetailPanel && !row.getIsGrouped() && (0, import_jsx_runtime55.jsx)(MRT_TableDetailPanel, { parentRowRef: rowRef, row, rowVirtualizer, staticRowIndex, table, virtualRow })] });
};
...
var MRT_TableBody = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [!(rowPinningDisplayMode === null || rowPinningDisplayMode === void 0 ? void 0 : rowPinningDisplayMode.includes("sticky")) && getIsSomeRowsPinned("top") && (0, import_jsx_runtime55.jsx)(TableBody_default, Object.assign({}, tableBodyProps, { sx: (theme) => Object.assign({ display: (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith("grid")) ? "grid" : void 0, position: "sticky", top: tableHeadHeight - 1, zIndex: 1 }, parseFromValuesOrFunc(tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.sx, theme)), children: getTopRows().map((row, staticRowIndex) => {
    ...
    textAlign: "center",
    width: "100%"
  }, children: globalFilter || columnFilters.length ? localization.noResultsFound : localization.noRecordsToDisplay }) }) }) : (0, import_jsx_runtime55.jsx)(import_jsx_runtime55.Fragment, { children: (virtualRows !== null && virtualRows !== void 0 ? virtualRows : rows).map((rowOrVirtualRow, staticRowIndex) => {
    ...
    return memoMode === "rows" ? (0, import_jsx_runtime55.jsx)(Memo_MRT_TableBodyRow, Object.assign({}, props), key) : (0, import_jsx_runtime55.jsx)(MRT_TableBodyRow, Object.assign({}, props), key);
  }) }) })), !(rowPinningDisplayMode === null || rowPinningDisplayMode === void 0 ? void 0 : rowPinningDisplayMode.includes("sticky")) && getIsSomeRowsPinned("bottom") && (0, import_jsx_runtime55.jsx)(TableBody_default, Object.assign({}, tableBodyProps, { sx: (theme) => Object.assign({ bottom: tableFooterHeight - 1, display: (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith("grid")) ? "grid" : void 0, position: "sticky", zIndex: 1 }, parseFromValuesOrFunc(tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.sx, theme)), children: getBottomRows().map((row, staticRowIndex) => {
    const props = Object.assign(Object.assign({}, commonRowProps), {
      row,
      staticRowIndex
    });
...
var MRT_FilterOptionMenu = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(Menu_default, Object.assign({ MenuListProps: {
    ...
    onSelectFilterMode: handleSelectFilterMode,
    table
  })) !== null && _e !== void 0 ? _e : internalFilterOptions.map(({ divider, label, option, symbol }, index) => (0, import_jsx_runtime55.jsx)(MRT_ActionMenuItem, { divider, icon: symbol, label, onClick: () => handleSelectFilterMode(option), selected: option === filterOption, table, value: option }, index)) }));
};
var MRT_ColumnActionMenu = (_a) => {
  ...
  const internalColumnMenuItems = [
    ...enableSorting && column.getCanSort() ? [
      enableSortingRemoval !== false && (0, import_jsx_runtime55.jsx)(MRT_ActionMenuItem, { disabled: column.getIsSorted() === false, icon: (0, import_jsx_runtime55.jsx)(ClearAllIcon, {}), label: localization.clearSort, onClick: handleClearSort, table }, 0),
      (0, import_jsx_runtime55.jsx)(MRT_ActionMenuItem, { disabled: column.getIsSorted() === "asc", icon: (0, import_jsx_runtime55.jsx)(SortIcon, { style: { transform: "rotate(180deg) scaleX(-1)" } }), label: (_c = localization.sortByColumnAsc) === null || _c === void 0 ? void 0 : _c.replace("{column}", String(columnDef.header)), onClick: handleSortAsc, table }, 1),
      (0, import_jsx_runtime55.jsx)(MRT_ActionMenuItem, { disabled: column.getIsSorted() === "desc", divider: enableColumnFilters || enableGrouping || enableHiding, icon: (0, import_jsx_runtime55.jsx)(SortIcon, {}), label: (_d = localization.sortByColumnDesc) === null || _d === void 0 ? void 0 : _d.replace("{column}", String(columnDef.header)), onClick: handleSortDesc, table }, 2)
    ] : [],
    ...enableColumnFilters && column.getCanFilter() ? [
      (0, import_jsx_runtime55.jsx)(MRT_ActionMenuItem, { disabled: !columnFilterValue || Array.isArray(columnFilterValue) && !columnFilterValue.filter((value) => value).length, icon: (0, import_jsx_runtime55.jsx)(FilterListOffIcon, {}), label: localization.clearFilter, onClick: handleClearFilter, table }, 3),
      columnFilterDisplayMode === "subheader" && (0, import_jsx_runtime55.jsx)(MRT_ActionMenuItem, { disabled: showColumnFilters && !enableColumnFilterModes, divider: enableGrouping || enableHiding, icon: (0, import_jsx_runtime55.jsx)(FilterListIcon, {}), label: (_e = localization.filterByColumn) === null || _e === void 0 ? void 0 : _e.replace("{column}", String(columnDef.header)), onClick: showColumnFilters ? handleOpenFilterModeMenu : handleFilterByColumn, onOpenSubMenu: showFilterModeSubMenu ? handleOpenFilterModeMenu : void 0, table }, 4),
      showFilterModeSubMenu && (0, import_jsx_runtime55.jsx)(MRT_FilterOptionMenu, { anchorEl: filterMenuAnchorEl, header, onSelect: handleFilterByColumn, setAnchorEl: setFilterMenuAnchorEl, table }, 5)
    ].filter(Boolean) : [],
    ...enableGrouping && column.getCanGroup() ? [
      (0, import_jsx_runtime55.jsx)(MRT_ActionMenuItem, { divider: enableColumnPinning, icon: (0, import_jsx_runtime55.jsx)(DynamicFeedIcon, {}), label: (_f = localization[column.getIsGrouped() ? "ungroupByColumn" : "groupByColumn"]) === null || _f === void 0 ? void 0 : _f.replace("{column}", String(columnDef.header)), onClick: handleGroupByColumn, table }, 6)
    ] : [],
    ...enableColumnPinning && column.getCanPin() ? [
      (0, import_jsx_runtime55.jsx)(MRT_ActionMenuItem, { disabled: column.getIsPinned() === "left" || !column.getCanPin(), icon: (0, import_jsx_runtime55.jsx)(PushPinIcon, { style: { transform: "rotate(90deg)" } }), label: localization.pinToLeft, onClick: () => handlePinColumn("left"), table }, 7),
      (0, import_jsx_runtime55.jsx)(MRT_ActionMenuItem, { disabled: column.getIsPinned() === "right" || !column.getCanPin(), icon: (0, import_jsx_runtime55.jsx)(PushPinIcon, { style: { transform: "rotate(-90deg)" } }), label: localization.pinToRight, onClick: () => handlePinColumn("right"), table }, 8),
      (0, import_jsx_runtime55.jsx)(MRT_ActionMenuItem, { disabled: !column.getIsPinned(), divider: enableHiding, icon: (0, import_jsx_runtime55.jsx)(PushPinIcon, {}), label: localization.unpin, onClick: () => handlePinColumn(false), table }, 9)
    ] : [],
    ...enableColumnResizing && column.getCanResize() ? [
      (0, import_jsx_runtime55.jsx)(MRT_ActionMenuItem, { disabled: columnSizing[column.id] === void 0, icon: (0, import_jsx_runtime55.jsx)(RestartAltIcon, {}), label: localization.resetColumnSize, onClick: handleResetColumnSize, table }, 10)
    ] : [],
    ...enableHiding ? [
      (0, import_jsx_runtime55.jsx)(MRT_ActionMenuItem, { disabled: !column.getCanHide(), icon: (0, import_jsx_runtime55.jsx)(VisibilityOffIcon, {}), label: (_g = localization.hideColumn) === null || _g === void 0 ? void 0 : _g.replace("{column}", String(columnDef.header)), onClick: handleHideColumn, table }, 11),
      (0, import_jsx_runtime55.jsx)(MRT_ActionMenuItem, { disabled: !Object.values(columnVisibility).filter((visible) => !visible).length, icon: (0, import_jsx_runtime55.jsx)(ViewColumnIcon, {}), label: (_h = localization.showAllColumns) === null || _h === void 0 ? void 0 : _h.replace("{column}", String(columnDef.header)), onClick: handleShowAllColumns, table }, 12)
    ] : []
  ].filter(Boolean);
  return (0, import_jsx_runtime55.jsx)(Menu_default, Object.assign({ MenuListProps: {
    dense: density === "compact",
...
var MRT_TableHeadCellColumnActionsButton = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(0, import_jsx_runtime55.jsx)(Tooltip_default, Object.assign({}, getCommonTooltipProps("top"), { title: (_b = iconButtonProps === null || iconButtonProps === void 0 ? void 0 : iconButtonProps.title) !== null && _b !== void 0 ? _b : localization.columnActions, children: (0, import_jsx_runtime55.jsx)(IconButton_default, Object.assign({ "aria-label": localization.columnActions, onClick: handleClick, size: "small" }, iconButtonProps, { sx: (theme) => Object.assign({ "&:hover": {
    opacity: 1
  }, height: "2rem", m: "-8px -4px", opacity: 0.3, transition: "all 150ms", width: "2rem" }, parseFromValuesOrFunc(iconButtonProps === null || iconButtonProps === void 0 ? void 0 : iconButtonProps.sx, theme)), title: void 0, children: (_c = iconButtonProps === null || iconButtonProps === void 0 ? void 0 : iconButtonProps.children) !== null && _c !== void 0 ? _c : (0, import_jsx_runtime55.jsx)(MoreVertIcon, { style: { transform: "scale(0.9)" } }) })) })), anchorEl && (0, import_jsx_runtime55.jsx)(MRT_ColumnActionMenu, { anchorEl, header, setAnchorEl, table })] });
};
var MRT_FilterCheckbox = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(Tooltip_default, Object.assign({}, getCommonTooltipProps(), { title: (_c = checkboxProps === null || checkboxProps === void 0 ? void 0 : checkboxProps.title) !== null && _c !== void 0 ? _c : filterLabel, children: (0, import_jsx_runtime55.jsx)(FormControlLabel_default, { control: (0, import_jsx_runtime55.jsx)(Checkbox_default, Object.assign({ checked: column.getFilterValue() === "true", color: column.getFilterValue() === void 0 ? "default" : "primary", indeterminate: column.getFilterValue() === void 0, size: density === "compact" ? "small" : "medium" }, checkboxProps, { onChange: (e, checked) => {
    var _a2;
...
var MRT_FilterTextField = (_a) => {
  ...
  if (columnDef.Filter) {
    return (0, import_jsx_runtime55.jsx)(import_jsx_runtime55.Fragment, { children: (_g = columnDef.Filter) === null || _g === void 0 ? void 0 : _g.call(columnDef, { column, header, rangeFilterIndex, table }) });
  }
  const endAdornment = !isAutocompleteFilter && !isDateFilter && !filterChipLabel ? (0, import_jsx_runtime55.jsx)(InputAdornment_default, { position: "end", sx: {
  ...
  }, children: (0, import_jsx_runtime55.jsx)(Tooltip_default, { placement: "right", title: (_j = localization.clearFilter) !== null && _j !== void 0 ? _j : "", children: (0, import_jsx_runtime55.jsx)("span", { children: (0, import_jsx_runtime55.jsx)(IconButton_default, { "aria-label": localization.clearFilter, disabled: !((_k = filterValue === null || filterValue === void 0 ? void 0 : filterValue.toString()) === null || _k === void 0 ? void 0 : _k.length), onClick: handleClear, size: "small", sx: {
    height: "2rem",
    transform: "scale(0.9)",
    width: "2rem"
  }, children: (0, import_jsx_runtime55.jsx)(CloseIcon, {}) }) }) }) }) : null;
  const startAdornment = showChangeModeButton ? (0, import_jsx_runtime55.jsxs)(InputAdornment_default, { position: "start", children: [(0, import_jsx_runtime55.jsx)(Tooltip_default, { title: localization.changeFilterMode, children: (0, import_jsx_runtime55.jsx)("span", { children: (0, import_jsx_runtime55.jsx)(IconButton_default, { "aria-label": localization.changeFilterMode, onClick: handleFilterMenuOpen, size: "small", sx: { height: "1.75rem", width: "1.75rem" }, children: (0, import_jsx_runtime55.jsx)(FilterListIcon, {}) }) }) }), filterChipLabel && (0, import_jsx_runtime55.jsx)(Chip_default, { label: filterChipLabel, onDelete: handleClearEmptyFilterChip })] }) : null;
  const commonTextFieldProps = Object.assign(Object.assign({ fullWidth: true, helperText: showChangeModeButton ? (0, import_jsx_runtime55.jsx)("label", { children: localization.filterMode.replace("{filterType}", localization[`filter${((_l = currentFilterOption === null || currentFilterOption === void 0 ? void 0 : currentFilterOption.charAt(0)) === null || _l === void 0 ? void 0 : _l.toUpperCase()) + (currentFilterOption === null || currentFilterOption === void 0 ? void 0 : currentFilterOption.slice(1))}`]) }) : null, inputRef: (inputRef) => {
  ...
  return (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(filterVariant === null || filterVariant === void 0 ? void 0 : filterVariant.startsWith("time")) ? (0, import_jsx_runtime55.jsx)(TimePicker, Object.assign({}, commonDatePickerProps, timePickerProps, { slotProps: {
  ...
  } })) : (filterVariant === null || filterVariant === void 0 ? void 0 : filterVariant.startsWith("datetime")) ? (0, import_jsx_runtime55.jsx)(DateTimePicker, Object.assign({}, commonDatePickerProps, dateTimePickerProps, { slotProps: {
  ...
  } })) : (filterVariant === null || filterVariant === void 0 ? void 0 : filterVariant.startsWith("date")) ? (0, import_jsx_runtime55.jsx)(DatePicker, Object.assign({}, commonDatePickerProps, datePickerProps, { slotProps: {
  ...
  }, value: autocompleteValue })) : (0, import_jsx_runtime55.jsx)(TextField_default, Object.assign({ select: isSelectFilter || isMultiSelectFilter }, commonTextFieldProps, { slotProps: Object.assign(Object.assign({}, commonTextFieldProps.slotProps), { inputLabel: Object.assign({ shrink: isSelectFilter || isMultiSelectFilter }, (_y = commonTextFieldProps.slotProps) === null || _y === void 0 ? void 0 : _y.inputLabel), select: Object.assign({ MenuProps: { disableScrollLock: true }, displayEmpty: true, multiple: isMultiSelectFilter, renderValue: isMultiSelectFilter ? (selected) => !Array.isArray(selected) || (selected === null || selected === void 0 ? void 0 : selected.length) === 0 ? (0, import_jsx_runtime55.jsx)(Box_default, { sx: { opacity: 0.5 }, children: filterPlaceholder }) : (0, import_jsx_runtime55.jsx)(Box_default, { sx: { display: "flex", flexWrap: "wrap", gap: "2px" }, children: selected.map((value) => {
    const selectedValue = dropdownOptions === null || dropdownOptions === void 0 ? void 0 : dropdownOptions.find((option) => getValueAndLabel(option).value === value);
    return (0, import_jsx_runtime55.jsx)(Chip_default, { label: getValueAndLabel(selectedValue).label }, value);
    ...
    (0, import_jsx_runtime55.jsx)(MenuItem_default, { disabled: true, divider: true, hidden: true, value: "", children: (0, import_jsx_runtime55.jsx)(Box_default, { sx: { opacity: 0.5 }, children: filterPlaceholder }) }, "p"),
    ...[
      (_0 = textFieldProps.children) !== null && _0 !== void 0 ? _0 : dropdownOptions === null || dropdownOptions === void 0 ? void 0 : dropdownOptions.map((option, index) => {
        ...
        return (0, import_jsx_runtime55.jsxs)(MenuItem_default, { sx: {
          alignItems: "center",
          display: "flex",
          gap: "0.5rem",
          m: 0
        }, value, children: [isMultiSelectFilter && (0, import_jsx_runtime55.jsx)(Checkbox_default, { checked: ((_a2 = column.getFilterValue()) !== null && _a2 !== void 0 ? _a2 : []).includes(value), sx: { mr: "0.5rem" } }), label, " ", !columnDef.filterSelectOptions && `(${facetedUniqueValues.get(value)})`] }, `${index}-${value}`);
      })
    ]
  ] })), (0, import_jsx_runtime55.jsx)(MRT_FilterOptionMenu, { anchorEl, header, setAnchorEl, setFilterValue, table })] });
};
var MRT_FilterRangeFields = (_a) => {
  var { header, table } = _a, rest = __rest(_a, ["header", "table"]);
  return (0, import_jsx_runtime55.jsx)(Box_default, Object.assign({}, rest, { sx: (theme) => Object.assign({ display: "grid", gap: "1rem", gridTemplateColumns: "1fr 1fr" }, parseFromValuesOrFunc(rest === null || rest === void 0 ? void 0 : rest.sx, theme)), children: [0, 1].map((rangeFilterIndex) => (0, import_jsx_runtime55.jsx)(MRT_FilterTextField, { header, rangeFilterIndex, table }, rangeFilterIndex)) }));
};
var MRT_FilterRangeSlider = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsxs)(Stack_default, { children: [(0, import_jsx_runtime55.jsx)(Slider_default, Object.assign({ disableSwap: true, max: max2, min: min2, onChange: (_event, values) => {
  ...
  }, sx: (theme) => Object.assign({ m: "auto", minWidth: `${column.getSize() - 50}px`, mt: !showChangeModeButton ? "10px" : "6px", px: "4px", width: "calc(100% - 8px)" }, parseFromValuesOrFunc(sliderProps === null || sliderProps === void 0 ? void 0 : sliderProps.sx, theme)) })), showChangeModeButton ? (0, import_jsx_runtime55.jsx)(FormHelperText_default, { sx: {
    fontSize: "0.75rem",
    lineHeight: "0.8rem",
    m: "-3px -6px",
    whiteSpace: "nowrap"
...
var MRT_TableHeadCellFilterContainer = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(Collapse_default, Object.assign({ in: showColumnFilters || columnFilterDisplayMode === "popover", mountOnEnter: true, unmountOnExit: true }, rest, { children: columnDef.filterVariant === "checkbox" ? (0, import_jsx_runtime55.jsx)(MRT_FilterCheckbox, { column, table }) : columnDef.filterVariant === "range-slider" ? (0, import_jsx_runtime55.jsx)(MRT_FilterRangeSlider, { header, table }) : isRangeFilter ? (0, import_jsx_runtime55.jsx)(MRT_FilterRangeFields, { header, table }) : (0, import_jsx_runtime55.jsx)(MRT_FilterTextField, { header, table }) }));
};
var MRT_TableHeadCellFilterLabel = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(0, import_jsx_runtime55.jsx)(Grow_default, { in: columnFilterDisplayMode === "popover" || !!filterValue && !isRangeFilter || isRangeFilter && (!!(filterValue === null || filterValue === void 0 ? void 0 : filterValue[0]) || !!(filterValue === null || filterValue === void 0 ? void 0 : filterValue[1])), unmountOnExit: true, children: (0, import_jsx_runtime55.jsx)(Box_default, { component: "span", sx: { flex: "0 0" }, children: (0, import_jsx_runtime55.jsx)(Tooltip_default, { placement: "top", title: filterTooltip, children: (0, import_jsx_runtime55.jsx)(IconButton_default, Object.assign({ disableRipple: true, onClick: (event) => {
    ...
    horizontal: "center",
    vertical: "bottom"
  }, children: (0, import_jsx_runtime55.jsx)(Box_default, { sx: { p: "1rem" }, children: (0, import_jsx_runtime55.jsx)(MRT_TableHeadCellFilterContainer, { header, table }) }) })] });
};
var MRT_TableHeadCellGrabHandle = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(MRT_GrabHandleButton, Object.assign({}, iconButtonProps, { onDragEnd: handleDragEnd, onDragStart: handleDragStart, table }));
};
var MRT_TableHeadCellResizeHandle = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(Box_default, { className: "Mui-TableHeadCell-ResizeHandle-Wrapper", onDoubleClick: () => {
    setColumnSizingInfo((old) => Object.assign(Object.assign({}, old), { isResizingColumn: false }));
    column.resetSize();
...
var MRT_TableHeadCellSortLabel = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(Tooltip_default, { placement: "top", title: sortTooltip, children: (0, import_jsx_runtime55.jsx)(Badge_default, { badgeContent: sorting.length > 1 ? column.getSortIndex() + 1 : 0, overlap: "circular", children: (0, import_jsx_runtime55.jsx)(TableSortLabel_default, Object.assign({ IconComponent: !isSorted ? (props) => (0, import_jsx_runtime55.jsx)(SyncAltIcon, Object.assign({}, props, { direction, style: {
...
var MRT_TableHeadCell = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsxs)(TableCell_default, Object.assign({ align: columnDefType === "group" ? "center" : theme.direction === "rtl" ? "right" : "left", "aria-sort": column.getIsSorted() ? column.getIsSorted() === "asc" ? "ascending" : "descending" : "none", colSpan: header.colSpan, "data-can-sort": column.getCanSort() || void 0, "data-index": staticColumnIndex, "data-pinned": !!isColumnPinned || void 0, "data-sort": column.getIsSorted() || void 0, onDragEnter: handleDragEnter, onDragOver: handleDragOver, ref: (node) => {
    ...
    tableCellProps,
    theme: theme2
  })), draggingBorders), children: [header.isPlaceholder ? null : (_c = tableCellProps.children) !== null && _c !== void 0 ? _c : (0, import_jsx_runtime55.jsxs)(Box_default, { className: "Mui-TableHeadCell-Content", sx: {
    alignItems: "center",
    display: "flex",
    ...
    position: "relative",
    width: "100%"
  }, children: [(0, import_jsx_runtime55.jsxs)(Box_default, { className: "Mui-TableHeadCell-Content-Labels", onClick: column.getToggleSortingHandler(), sx: {
    alignItems: "center",
  ...
  }, children: [(0, import_jsx_runtime55.jsx)(Box_default, { className: "Mui-TableHeadCell-Content-Wrapper", sx: {
    "&:hover": {
      textOverflow: "clip"
    },
  ...
  }, children: HeaderElement }), column.getCanFilter() && (0, import_jsx_runtime55.jsx)(MRT_TableHeadCellFilterLabel, { header, table }), column.getCanSort() && (0, import_jsx_runtime55.jsx)(MRT_TableHeadCellSortLabel, { header, table })] }), columnDefType !== "group" && (0, import_jsx_runtime55.jsxs)(Box_default, { className: "Mui-TableHeadCell-Content-Actions", sx: {
    whiteSpace: "nowrap"
  }, children: [showDragHandle && (0, import_jsx_runtime55.jsx)(MRT_TableHeadCellGrabHandle, { column, table, tableHeadCellRef: {
    current: (_j = tableHeadCellRefs.current) === null || _j === void 0 ? void 0 : _j[column.id]
  } }), showColumnActions && (0, import_jsx_runtime55.jsx)(MRT_TableHeadCellColumnActionsButton, { header, table })] }), column.getCanResize() && (0, import_jsx_runtime55.jsx)(MRT_TableHeadCellResizeHandle, { header, table })] }), columnFilterDisplayMode === "subheader" && column.getCanFilter() && (0, import_jsx_runtime55.jsx)(MRT_TableHeadCellFilterContainer, { header, table })] }));
};
var MRT_TableHeadRow = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsxs)(TableRow_default, Object.assign({}, tableRowProps, { sx: (theme) => Object.assign({ backgroundColor: baseBackgroundColor, boxShadow: `4px 0 8px ${alpha(theme.palette.common.black, 0.1)}`, display: (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith("grid")) ? "flex" : void 0, position: enableStickyHeader && layoutMode === "semantic" ? "sticky" : "relative", top: 0 }, parseFromValuesOrFunc(tableRowProps === null || tableRowProps === void 0 ? void 0 : tableRowProps.sx, theme)), children: [virtualPaddingLeft ? (0, import_jsx_runtime55.jsx)("th", { style: { display: "flex", width: virtualPaddingLeft } }) : null, (virtualColumns !== null && virtualColumns !== void 0 ? virtualColumns : headerGroup.headers).map((headerOrVirtualHeader, staticColumnIndex) => {
    ...
    return header ? (0, import_jsx_runtime55.jsx)(MRT_TableHeadCell, { columnVirtualizer, header, staticColumnIndex, table }, header.id) : null;
  }), virtualPaddingRight ? (0, import_jsx_runtime55.jsx)("th", { style: { display: "flex", width: virtualPaddingRight } }) : null] }));
};
var MRT_ToolbarAlertBanner = (_a) => {
  ...
  const selectedAlert = selectedRowCount > 0 ? (0, import_jsx_runtime55.jsxs)(Stack_default, { alignItems: "center", direction: "row", gap: "16px", children: [(_c = (_b = localization.selectedCountOfRowCountRowsSelected) === null || _b === void 0 ? void 0 : _b.replace("{selectedCount}", selectedRowCount.toLocaleString(localization.language))) === null || _c === void 0 ? void 0 : _c.replace("{rowCount}", totalRowCount.toLocaleString(localization.language)), (0, import_jsx_runtime55.jsx)(Button_default, { onClick: (event) => getMRT_SelectAllHandler({ table })(event, false, true), size: "small", sx: { p: "2px" }, children: localization.clearSelection })] }) : null;
  const groupedAlert = grouping.length > 0 ? (0, import_jsx_runtime55.jsxs)("span", { children: [localization.groupedBy, " ", grouping.map((columnId, index) => (0, import_jsx_runtime55.jsxs)(import_react.Fragment, { children: [index > 0 ? localization.thenBy : "", (0, import_jsx_runtime55.jsx)(Chip_default, Object.assign({ label: table.getColumn(columnId).columnDef.header, onDelete: () => table.getColumn(columnId).toggleGrouping() }, chipProps))] }, `${index}-${columnId}`))] }) : null;
  return (0, import_jsx_runtime55.jsx)(Collapse_default, { in: showAlertBanner || !!selectedAlert || !!groupedAlert, timeout: stackAlertBanner ? 200 : 0, children: (0, import_jsx_runtime55.jsx)(Alert_default, Object.assign({ color: "info", icon: false }, alertProps, { sx: (theme) => {
    var _a2, _b2;
    ...
    selectedAlert,
    table
  })) !== null && _d !== void 0 ? _d : (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(alertProps === null || alertProps === void 0 ? void 0 : alertProps.title) && (0, import_jsx_runtime55.jsx)(AlertTitle_default, { children: alertProps.title }), (0, import_jsx_runtime55.jsxs)(Stack_default, { sx: {
  ...
  }, children: [alertProps === null || alertProps === void 0 ? void 0 : alertProps.children, (alertProps === null || alertProps === void 0 ? void 0 : alertProps.children) && (selectedAlert || groupedAlert) && (0, import_jsx_runtime55.jsx)("br", {}), (0, import_jsx_runtime55.jsxs)(Box_default, { sx: { display: "flex" }, children: [enableRowSelection && enableSelectAll && positionToolbarAlertBanner === "head-overlay" && (0, import_jsx_runtime55.jsx)(MRT_SelectCheckbox, { table }), " ", selectedAlert] }), selectedAlert && groupedAlert && (0, import_jsx_runtime55.jsx)("br", {}), groupedAlert] })] }) })) });
};
var MRT_TableHead = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(TableHead_default, Object.assign({}, tableHeadProps, { ref: (ref) => {
    tableHeadRef.current = ref;
    if (tableHeadProps === null || tableHeadProps === void 0 ? void 0 : tableHeadProps.ref) {
      tableHeadProps.ref.current = ref;
    }
  }, sx: (theme) => Object.assign({ display: (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith("grid")) ? "grid" : void 0, opacity: 0.97, position: stickyHeader ? "sticky" : "relative", top: stickyHeader && (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith("grid")) ? 0 : void 0, zIndex: stickyHeader ? 2 : void 0 }, parseFromValuesOrFunc(tableHeadProps === null || tableHeadProps === void 0 ? void 0 : tableHeadProps.sx, theme)), children: positionToolbarAlertBanner === "head-overlay" && (showAlertBanner || table.getSelectedRowModel().rows.length > 0) ? (0, import_jsx_runtime55.jsx)("tr", { style: {
    display: (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith("grid")) ? "grid" : void 0
  }, children: (0, import_jsx_runtime55.jsx)("th", { colSpan: table.getVisibleLeafColumns().length, style: {
    display: (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith("grid")) ? "grid" : void 0,
    padding: 0
  }, children: (0, import_jsx_runtime55.jsx)(MRT_ToolbarAlertBanner, { table }) }) }) : table.getHeaderGroups().map((headerGroup) => (0, import_jsx_runtime55.jsx)(MRT_TableHeadRow, { columnVirtualizer, headerGroup, table }, headerGroup.id)) }));
};
var MRT_Table = (_a) => {
  var { table } = _a, rest = __rest(_a, ["table"]);
  ...
  return (0, import_jsx_runtime55.jsxs)(Table_default, Object.assign({ stickyHeader: enableStickyHeader || isFullScreen }, tableProps, { style: Object.assign(Object.assign({}, columnSizeVars), tableProps === null || tableProps === void 0 ? void 0 : tableProps.style), sx: (theme) => Object.assign({ borderCollapse: "separate", display: (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith("grid")) ? "grid" : void 0, position: "relative" }, parseFromValuesOrFunc(tableProps === null || tableProps === void 0 ? void 0 : tableProps.sx, theme)), children: [!!Caption && (0, import_jsx_runtime55.jsx)("caption", { children: Caption }), enableTableHead && (0, import_jsx_runtime55.jsx)(MRT_TableHead, Object.assign({}, commonTableGroupProps)), memoMode === "table-body" || columnSizingInfo.isResizingColumn ? (0, import_jsx_runtime55.jsx)(Memo_MRT_TableBody, Object.assign({}, commonTableGroupProps)) : (0, import_jsx_runtime55.jsx)(MRT_TableBody, Object.assign({}, commonTableGroupProps)), enableTableFooter && (0, import_jsx_runtime55.jsx)(MRT_TableFooter, Object.assign({}, commonTableGroupProps))] }));
};
var MRT_TableLoadingOverlay = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(Box_default, { sx: {
    alignItems: "center",
    ...
    width: "100%",
    zIndex: 3
  }, children: (_b = circularProgressProps === null || circularProgressProps === void 0 ? void 0 : circularProgressProps.Component) !== null && _b !== void 0 ? _b : (0, import_jsx_runtime55.jsx)(CircularProgress_default, Object.assign({ "aria-label": localization.noRecordsToDisplay, id: `mrt-progress-${id}` }, circularProgressProps)) });
};
var MRT_CellActionMenu = (_a) => {
  ...
  const internalMenuItems = [
    (parseFromValuesOrFunc(enableClickToCopy, cell) === "context-menu" || parseFromValuesOrFunc(columnDef.enableClickToCopy, cell) === "context-menu") && (0, import_jsx_runtime55.jsx)(MRT_ActionMenuItem, { icon: (0, import_jsx_runtime55.jsx)(ContentCopy, {}), label: localization.copy, onClick: (event) => {
      event.stopPropagation();
      navigator.clipboard.writeText(cell.getValue());
      handleClose();
    }, table }, "mrt-copy"),
    parseFromValuesOrFunc(enableEditing, row) && editDisplayMode === "cell" && (0, import_jsx_runtime55.jsx)(MRT_ActionMenuItem, { icon: (0, import_jsx_runtime55.jsx)(EditIcon, {}), label: localization.edit, onClick: () => {
      openEditingCell({ cell, table });
      handleClose();
    }, table }, "mrt-edit")
  ].filter(Boolean);
  ...
  return (!!(menuItems === null || menuItems === void 0 ? void 0 : menuItems.length) || !!(internalMenuItems === null || internalMenuItems === void 0 ? void 0 : internalMenuItems.length)) && (0, import_jsx_runtime55.jsx)(Menu_default, Object.assign({ MenuListProps: {
    dense: density === "compact",
    sx: {
      backgroundColor: menuBackgroundColor
    }
...
var MRT_EditRowModal = (_a) => {
  ...
  const internalEditComponents = row.getAllCells().filter((cell) => cell.column.columnDef.columnDefType === "data").map((cell) => (0, import_jsx_runtime55.jsx)(MRT_EditCellTextField, { cell, table }, cell.id));
  return (0, import_jsx_runtime55.jsx)(Dialog_default, Object.assign({ fullWidth: true, maxWidth: "xs", onClose: (event, reason) => {
    var _a2;
    if (creatingRow) {
      onCreatingRowCancel === null || onCreatingRowCancel === void 0 ? void 0 : onCreatingRowCancel({ row, table });
      setCreatingRow(null);
    ...
    row,
    table
  }))) !== null && _b !== void 0 ? _b : (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(0, import_jsx_runtime55.jsx)(DialogTitle_default, { sx: { textAlign: "center" }, children: localization.edit }), (0, import_jsx_runtime55.jsx)(DialogContent_default, { children: (0, import_jsx_runtime55.jsx)("form", { onSubmit: (e) => e.preventDefault(), children: (0, import_jsx_runtime55.jsx)(Stack_default, { sx: {
    gap: "32px",
    paddingTop: "16px",
    width: "100%"
  }, children: internalEditComponents }) }) }), (0, import_jsx_runtime55.jsx)(DialogActions_default, { sx: { p: "1.25rem" }, children: (0, import_jsx_runtime55.jsx)(MRT_EditActionButtons, { row, table, variant: "text" }) })] }) }));
};
...
var MRT_TableContainer = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsxs)(TableContainer_default, Object.assign({ "aria-busy": loading, "aria-describedby": loading ? "mrt-progress" : void 0 }, tableContainerProps, { ref: (node) => {
    if (node) {
...
var MRT_LinearProgressBar = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(Collapse_default, { in: showProgressBars !== false && (showProgressBars || isSaving), mountOnEnter: true, sx: {
    bottom: isTopToolbar ? 0 : void 0,
    position: "absolute",
    top: !isTopToolbar ? 0 : void 0,
    width: "100%"
  }, unmountOnExit: true, children: (0, import_jsx_runtime55.jsx)(LinearProgress_default, Object.assign({ "aria-busy": "true", "aria-label": "Loading", sx: { position: "relative" } }, linearProgressProps)) });
};
...
var MRT_TablePagination = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsxs)(Box_default, { className: "MuiTablePagination-root", sx: {
    alignItems: "center",
    display: "flex",
    flexWrap: "wrap",
    gap: "8px",
    ...
    py: "12px",
    zIndex: 2
  }, children: [showRowsPerPage && (0, import_jsx_runtime55.jsxs)(Box_default, { sx: { alignItems: "center", display: "flex", gap: "8px" }, children: [(0, import_jsx_runtime55.jsx)(InputLabel_default, { htmlFor: `mrt-rows-per-page-${id}`, sx: { mb: 0 }, children: localization.rowsPerPage }), (0, import_jsx_runtime55.jsx)(Select_default, Object.assign({ MenuProps: { disableScrollLock: true }, disableUnderline: true, disabled, inputProps: {
    ...
    return (_a2 = SelectProps === null || SelectProps === void 0 ? void 0 : SelectProps.children) !== null && _a2 !== void 0 ? _a2 : (SelectProps === null || SelectProps === void 0 ? void 0 : SelectProps.native) ? (0, import_jsx_runtime55.jsx)("option", { value, children: label }, value) : (0, import_jsx_runtime55.jsx)(MenuItem_default, { sx: { m: 0 }, value, children: label }, value);
  }) }))] }), paginationDisplayMode === "pages" ? (0, import_jsx_runtime55.jsx)(Pagination_default, Object.assign({ count: numberOfPages, disabled, onChange: (_e, newPageIndex) => table.setPageIndex(newPageIndex - 1), page: pageIndex + 1, renderItem: (item) => (0, import_jsx_runtime55.jsx)(PaginationItem_default, Object.assign({ slots: {
    first: FirstPageIcon,
    last: LastPageIcon,
    next: ChevronRightIcon,
    previous: ChevronLeftIcon
  } }, item)), showFirstButton, showLastButton }, restPaginationProps)) : paginationDisplayMode === "default" ? (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(0, import_jsx_runtime55.jsx)(Typography_default, { align: "center", component: "span", sx: { m: "0 4px", minWidth: "8ch" }, variant: "body2", children: `${lastRowIndex === 0 ? 0 : (firstRowIndex + 1).toLocaleString(localization.language)}-${lastRowIndex.toLocaleString(localization.language)} ${localization.of} ${totalRowCount.toLocaleString(localization.language)}` }), (0, import_jsx_runtime55.jsxs)(Box_default, { gap: "xs", children: [showFirstButton && (0, import_jsx_runtime55.jsx)(Tooltip_default, Object.assign({}, tooltipProps, { title: localization.goToFirstPage, children: (0, import_jsx_runtime55.jsx)("span", { children: (0, import_jsx_runtime55.jsx)(IconButton_default, { "aria-label": localization.goToFirstPage, disabled: disableBack, onClick: () => table.firstPage(), size: "small", children: (0, import_jsx_runtime55.jsx)(FirstPageIcon, Object.assign({}, flipIconStyles(theme))) }) }) })), (0, import_jsx_runtime55.jsx)(Tooltip_default, Object.assign({}, tooltipProps, { title: localization.goToPreviousPage, children: (0, import_jsx_runtime55.jsx)("span", { children: (0, import_jsx_runtime55.jsx)(IconButton_default, { "aria-label": localization.goToPreviousPage, disabled: disableBack, onClick: () => table.previousPage(), size: "small", children: (0, import_jsx_runtime55.jsx)(ChevronLeftIcon, Object.assign({}, flipIconStyles(theme))) }) }) })), (0, import_jsx_runtime55.jsx)(Tooltip_default, Object.assign({}, tooltipProps, { title: localization.goToNextPage, children: (0, import_jsx_runtime55.jsx)("span", { children: (0, import_jsx_runtime55.jsx)(IconButton_default, { "aria-label": localization.goToNextPage, disabled: disableNext, onClick: () => table.nextPage(), size: "small", children: (0, import_jsx_runtime55.jsx)(ChevronRightIcon, Object.assign({}, flipIconStyles(theme))) }) }) })), showLastButton && (0, import_jsx_runtime55.jsx)(Tooltip_default, Object.assign({}, tooltipProps, { title: localization.goToLastPage, children: (0, import_jsx_runtime55.jsx)("span", { children: (0, import_jsx_runtime55.jsx)(IconButton_default, { "aria-label": localization.goToLastPage, disabled: disableNext, onClick: () => table.lastPage(), size: "small", children: (0, import_jsx_runtime55.jsx)(LastPageIcon, Object.assign({}, flipIconStyles(theme))) }) }) }))] })] }) : null] });
};
var MRT_ToolbarDropZone = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(Fade_default, { in: showToolbarDropZone, children: (0, import_jsx_runtime55.jsx)(Box_default, Object.assign({ className: "Mui-ToolbarDropZone", onDragEnter: handleDragEnter, onDragOver: handleDragOver }, rest, { sx: (theme) => Object.assign({ alignItems: "center", backdropFilter: "blur(4px)", backgroundColor: alpha(theme.palette.info.main, (hoveredColumn === null || hoveredColumn === void 0 ? void 0 : hoveredColumn.id) === "drop-zone" ? 0.2 : 0.1), border: `dashed ${theme.palette.info.main} 2px`, boxSizing: "border-box", display: "flex", height: "100%", justifyContent: "center", position: "absolute", width: "100%", zIndex: 4 }, parseFromValuesOrFunc(rest === null || rest === void 0 ? void 0 : rest.sx, theme)), children: (0, import_jsx_runtime55.jsx)(Typography_default, { fontStyle: "italic", children: localization.dropToGroupBy.replace("{column}", (_c = (_b = draggingColumn === null || draggingColumn === void 0 ? void 0 : draggingColumn.columnDef) === null || _b === void 0 ? void 0 : _b.header) !== null && _c !== void 0 ? _c : "") }) })) });
};
var MRT_BottomToolbar = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsxs)(Box_default, Object.assign({}, toolbarProps, { ref: (node) => {
    if (node) {
  ...
  }, sx: (theme) => Object.assign(Object.assign(Object.assign({}, getCommonToolbarStyles({ table, theme })), { bottom: isFullScreen ? "0" : void 0, boxShadow: `0 1px 2px -1px ${alpha(theme.palette.grey[700], 0.5)} inset`, left: 0, position: isFullScreen ? "fixed" : "relative", right: 0 }), parseFromValuesOrFunc(toolbarProps === null || toolbarProps === void 0 ? void 0 : toolbarProps.sx, theme)), children: [(0, import_jsx_runtime55.jsx)(MRT_LinearProgressBar, { isTopToolbar: false, table }), positionToolbarAlertBanner === "bottom" && (0, import_jsx_runtime55.jsx)(MRT_ToolbarAlertBanner, { stackAlertBanner, table }), ["both", "bottom"].includes(positionToolbarDropZone !== null && positionToolbarDropZone !== void 0 ? positionToolbarDropZone : "") && (0, import_jsx_runtime55.jsx)(MRT_ToolbarDropZone, { table }), (0, import_jsx_runtime55.jsxs)(Box_default, { sx: {
    alignItems: "center",
    ...
    p: "0.5rem",
    width: "100%"
  }, children: [renderBottomToolbarCustomActions ? renderBottomToolbarCustomActions({ table }) : (0, import_jsx_runtime55.jsx)("span", {}), (0, import_jsx_runtime55.jsx)(Box_default, { sx: {
    display: "flex",
    justifyContent: "flex-end",
    position: stackAlertBanner ? "relative" : "absolute",
    right: 0,
    top: 0
  }, children: enablePagination && ["both", "bottom"].includes(positionPagination !== null && positionPagination !== void 0 ? positionPagination : "") && (0, import_jsx_runtime55.jsx)(MRT_TablePagination, { position: "bottom", table }) })] })] }));
};
var MRT_ColumnPinningButtons = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(Box_default, Object.assign({}, rest, { sx: (theme) => Object.assign({ minWidth: "70px", textAlign: "center" }, parseFromValuesOrFunc(rest === null || rest === void 0 ? void 0 : rest.sx, theme)), children: column.getIsPinned() ? (0, import_jsx_runtime55.jsx)(Tooltip_default, { title: localization.unpin, children: (0, import_jsx_runtime55.jsx)(IconButton_default, { onClick: () => handlePinColumn(false), size: "small", children: (0, import_jsx_runtime55.jsx)(PushPinIcon, {}) }) }) : (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(0, import_jsx_runtime55.jsx)(Tooltip_default, { title: localization.pinToLeft, children: (0, import_jsx_runtime55.jsx)(IconButton_default, { onClick: () => handlePinColumn("left"), size: "small", children: (0, import_jsx_runtime55.jsx)(PushPinIcon, { style: {
    transform: "rotate(90deg)"
  } }) }) }), (0, import_jsx_runtime55.jsx)(Tooltip_default, { title: localization.pinToRight, children: (0, import_jsx_runtime55.jsx)(IconButton_default, { onClick: () => handlePinColumn("right"), size: "small", children: (0, import_jsx_runtime55.jsx)(PushPinIcon, { style: {
    transform: "rotate(-90deg)"
  } }) }) })] }) }));
};
var MRT_ShowHideColumnsMenuItems = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(0, import_jsx_runtime55.jsx)(MenuItem_default, Object.assign({ disableRipple: true, onDragEnter: handleDragEnter, ref: menuItemRef }, rest, { sx: (theme) => Object.assign({ alignItems: "center", justifyContent: "flex-start", my: 0, opacity: isDragging ? 0.5 : 1, outline: isDragging ? `2px dashed ${theme.palette.grey[500]}` : (hoveredColumn === null || hoveredColumn === void 0 ? void 0 : hoveredColumn.id) === column.id ? `2px dashed ${draggingBorderColor}` : "none", outlineOffset: "-2px", pl: `${(column.depth + 0.5) * 2}rem`, py: "6px" }, parseFromValuesOrFunc(rest === null || rest === void 0 ? void 0 : rest.sx, theme)), children: (0, import_jsx_runtime55.jsxs)(Box_default, { sx: {
    display: "flex",
    flexWrap: "nowrap",
    gap: "8px"
  }, children: [columnDefType !== "group" && enableColumnOrdering && !isNestedColumns && (columnDef.enableColumnOrdering !== false ? (0, import_jsx_runtime55.jsx)(MRT_GrabHandleButton, { onDragEnd: handleDragEnd, onDragStart: handleDragStart, table }) : (0, import_jsx_runtime55.jsx)(Box_default, { sx: { width: "28px" } })), enableColumnPinning && (column.getCanPin() ? (0, import_jsx_runtime55.jsx)(MRT_ColumnPinningButtons, { column, table }) : (0, import_jsx_runtime55.jsx)(Box_default, { sx: { width: "70px" } })), enableHiding ? (0, import_jsx_runtime55.jsx)(FormControlLabel_default, { checked: switchChecked, componentsProps: {
    typography: {
      sx: {
        mb: 0,
  ...
  }, control: (0, import_jsx_runtime55.jsx)(Tooltip_default, Object.assign({}, getCommonTooltipProps(), { title: localization.toggleVisibility, children: (0, import_jsx_runtime55.jsx)(Switch_default, {}) })), disabled: !column.getCanHide(), label: columnDef.header, onChange: () => handleToggleColumnHidden(column) }) : (0, import_jsx_runtime55.jsx)(Typography_default, { sx: { alignSelf: "center" }, children: columnDef.header })] }) })), (_b = column.columns) === null || _b === void 0 ? void 0 : _b.map((c, i) => (0, import_jsx_runtime55.jsx)(MRT_ShowHideColumnsMenuItems, { allColumns, column: c, hoveredColumn, isNestedColumns, setHoveredColumn, table }, `${i}-${c.id}`))] });
};
var MRT_ShowHideColumnsMenu = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsxs)(Menu_default, Object.assign({ MenuListProps: {
    dense: density === "compact",
    sx: {
      backgroundColor: menuBackgroundColor
    }
  }, anchorEl, disableScrollLock: true, onClose: () => setAnchorEl(null), open: !!anchorEl }, rest, { children: [(0, import_jsx_runtime55.jsxs)(Box_default, { sx: {
    display: "flex",
    justifyContent: "space-between",
    p: "0.5rem",
    pt: 0
  }, children: [enableHiding && (0, import_jsx_runtime55.jsx)(Button_default, { disabled: !getIsSomeColumnsVisible(), onClick: () => handleToggleAllColumns(false), children: localization.hideAll }), enableColumnOrdering && (0, import_jsx_runtime55.jsx)(Button_default, { onClick: () => table.setColumnOrder(getDefaultColumnOrderIds(table.options, true)), disabled: !hasColumnOrderChanged, children: localization.resetOrder }), enableColumnPinning && (0, import_jsx_runtime55.jsx)(Button_default, { disabled: !getIsSomeColumnsPinned(), onClick: () => table.resetColumnPinning(true), children: localization.unpinAll }), enableHiding && (0, import_jsx_runtime55.jsx)(Button_default, { disabled: getIsAllColumnsVisible(), onClick: () => handleToggleAllColumns(true), children: localization.showAll })] }), (0, import_jsx_runtime55.jsx)(Divider_default, {}), allColumns.map((column, index) => (0, import_jsx_runtime55.jsx)(MRT_ShowHideColumnsMenuItems, { allColumns, column, hoveredColumn, isNestedColumns, setHoveredColumn, table }, `${index}-${column.id}`))] }));
};
var MRT_ShowHideColumnsButton = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [(0, import_jsx_runtime55.jsx)(Tooltip_default, { title: (_b = rest === null || rest === void 0 ? void 0 : rest.title) !== null && _b !== void 0 ? _b : localization.showHideColumns, children: (0, import_jsx_runtime55.jsx)(IconButton_default, Object.assign({ "aria-label": localization.showHideColumns, onClick: handleClick }, rest, { title: void 0, children: (0, import_jsx_runtime55.jsx)(ViewColumnIcon, {}) })) }), anchorEl && (0, import_jsx_runtime55.jsx)(MRT_ShowHideColumnsMenu, { anchorEl, setAnchorEl, table })] });
};
var MRT_ToggleDensePaddingButton = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(Tooltip_default, { title: (_b = rest === null || rest === void 0 ? void 0 : rest.title) !== null && _b !== void 0 ? _b : localization.toggleDensity, children: (0, import_jsx_runtime55.jsx)(IconButton_default, Object.assign({ "aria-label": localization.toggleDensity, onClick: handleToggleDensePadding }, rest, { title: void 0, children: density === "compact" ? (0, import_jsx_runtime55.jsx)(DensitySmallIcon, {}) : density === "comfortable" ? (0, import_jsx_runtime55.jsx)(DensityMediumIcon, {}) : (0, import_jsx_runtime55.jsx)(DensityLargeIcon, {}) })) });
};
var MRT_ToggleFiltersButton = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(Tooltip_default, { title: (_b = rest === null || rest === void 0 ? void 0 : rest.title) !== null && _b !== void 0 ? _b : localization.showHideFilters, children: (0, import_jsx_runtime55.jsx)(IconButton_default, Object.assign({ "aria-label": localization.showHideFilters, onClick: handleToggleShowFilters }, rest, { title: void 0, children: showColumnFilters ? (0, import_jsx_runtime55.jsx)(FilterListOffIcon, {}) : (0, import_jsx_runtime55.jsx)(FilterListIcon, {}) })) });
};
var MRT_ToggleFullScreenButton = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(Tooltip_default, { open: tooltipOpened, title: (_b = rest === null || rest === void 0 ? void 0 : rest.title) !== null && _b !== void 0 ? _b : localization.toggleFullScreen, children: (0, import_jsx_runtime55.jsx)(IconButton_default, Object.assign({ "aria-label": localization.toggleFullScreen, onBlur: () => setTooltipOpened(false), onClick: handleToggleFullScreen, onFocus: () => setTooltipOpened(true), onMouseEnter: () => setTooltipOpened(true), onMouseLeave: () => setTooltipOpened(false) }, rest, { title: void 0, children: isFullScreen ? (0, import_jsx_runtime55.jsx)(FullscreenExitIcon, {}) : (0, import_jsx_runtime55.jsx)(FullscreenIcon, {}) })) });
};
var MRT_ToggleGlobalFilterButton = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(Tooltip_default, { title: (_b = rest === null || rest === void 0 ? void 0 : rest.title) !== null && _b !== void 0 ? _b : localization.showHideSearch, children: (0, import_jsx_runtime55.jsx)(IconButton_default, Object.assign({ "aria-label": (_c = rest === null || rest === void 0 ? void 0 : rest.title) !== null && _c !== void 0 ? _c : localization.showHideSearch, disabled: !!globalFilter && showGlobalFilter, onClick: handleToggleSearch }, rest, { title: void 0, children: showGlobalFilter ? (0, import_jsx_runtime55.jsx)(SearchOffIcon, {}) : (0, import_jsx_runtime55.jsx)(SearchIcon, {}) })) });
};
var MRT_ToolbarInternalButtons = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsx)(Box_default, Object.assign({}, rest, { sx: (theme) => Object.assign({ alignItems: "center", display: "flex", zIndex: 3 }, parseFromValuesOrFunc(rest === null || rest === void 0 ? void 0 : rest.sx, theme)), children: (_b = renderToolbarInternalActions === null || renderToolbarInternalActions === void 0 ? void 0 : renderToolbarInternalActions({
    table
  })) !== null && _b !== void 0 ? _b : (0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, { children: [enableFilters && enableGlobalFilter && !(initialState === null || initialState === void 0 ? void 0 : initialState.showGlobalFilter) && (0, import_jsx_runtime55.jsx)(MRT_ToggleGlobalFilterButton, { table }), enableFilters && enableColumnFilters && columnFilterDisplayMode !== "popover" && (0, import_jsx_runtime55.jsx)(MRT_ToggleFiltersButton, { table }), (enableHiding || enableColumnOrdering || enableColumnPinning) && (0, import_jsx_runtime55.jsx)(MRT_ShowHideColumnsButton, { table }), enableDensityToggle && (0, import_jsx_runtime55.jsx)(MRT_ToggleDensePaddingButton, { table }), enableFullScreenToggle && (0, import_jsx_runtime55.jsx)(MRT_ToggleFullScreenButton, { table })] }) }));
};
var MRT_GlobalFilterTextField = (_a) => {
  ...
  return (0, import_jsx_runtime55.jsxs)(Collapse_default, { in: showGlobalFilter, mountOnEnter: true, orientation: "horizontal", unmountOnExit: true, children: [(0, import_jsx_runtime55.jsx)(TextField_default, Object.assign({ inputProps: Object.assign({ autoComplete: "off" }, textFieldProps.inputProps), onChange: handleChange, placeholder: localization.search, size: "small", value: searchValue !== null && searchValue !== void 0 ? searchValue : "", variant: "outlined" }, textFieldProps, { InputProps: Object.assign(Object.assign({ endAdornment: (0, import_jsx_runtime55.jsx)(InputAdornment_default, { position: "end", children: (0, import_jsx_runtime55.jsx)(Tooltip_default, { title: (_b = localization.clearSearch) !== null && _b !== void 0 ? _b : "", children: (0, import_jsx_runtime55.jsx)("span", { children: (0, import_jsx_runtime55.jsx)(IconButton_default, { "aria-label": localization.clearSearch, disabled: !(searchValue === null || searchValue === void 0 ? void 0 : searchValue.length), onClick: handleClear, size: "small", children: (0, import_jsx_runtime55.jsx)(CloseIcon, {}) }) }) }) }), startAdornment: enableGlobalFilterModes ? (0, import_jsx_runtime55.jsx)(InputAdornment_default, { position: "start", children: (0, import_jsx_runtime55.jsx)(Tooltip_default, { title: localization.changeSearchMode, children: (0, import_jsx_runtime55.jsx)(IconButton_default, { "aria-label": localization.changeSearchMode, onClick: handleGlobalFilterMenuOpen, size: "small", sx: { height: "1.75rem", width: "1.75rem" }, children: (0, import_jsx_runtime55.jsx)(SearchIcon, {}) }) }) }) : (0, import_jsx_runtime55.jsx)(SearchIcon, { style: { marginRight: "4px" } }) }, textFieldProps.InputProps), { sx: (theme) => {
    var _a2;
    return Object.assign({ mb: 0 }, parseFromValuesOrFunc((_a2 = textFieldProps === null || textFieldProps === void 0 ? void 0 : textFieldProps.InputProps) === null || _a2 === void 0 ? void 0 : _a2.sx, theme));
  } }), inputRef: (inputRef) => {
  ...
  } })), (0, import_jsx_runtime55.jsx)(MRT_FilterOptionMenu, { anchorEl, onSelect: handleClear, setAnchorEl, table })] });
};
var MRT_TopToolbar = ({ table }) => {
  ...
  return (0, import_jsx_runtime55.jsxs)(Box_default, Object.assign({}, toolbarProps, { ref: (ref) => {
    topToolbarRef.current = ref;
    if (toolbarProps === null || toolbarProps === void 0 ? void 0 : toolbarProps.ref) {
      toolbarProps.ref.current = ref;
    }
  }, sx: (theme) => Object.assign(Object.assign(Object.assign({}, getCommonToolbarStyles({ table, theme })), { position: isFullScreen ? "sticky" : "relative", top: isFullScreen ? "0" : void 0 }), parseFromValuesOrFunc(toolbarProps === null || toolbarProps === void 0 ? void 0 : toolbarProps.sx, theme)), children: [positionToolbarAlertBanner === "top" && (0, import_jsx_runtime55.jsx)(MRT_ToolbarAlertBanner, { stackAlertBanner, table }), ["both", "top"].includes(positionToolbarDropZone !== null && positionToolbarDropZone !== void 0 ? positionToolbarDropZone : "") && (0, import_jsx_runtime55.jsx)(MRT_ToolbarDropZone, { table }), (0, import_jsx_runtime55.jsxs)(Box_default, { sx: {
    alignItems: "flex-start",
    boxSizing: "border-box",
    display: "flex",
    gap: "0.5rem",
    ...
    top: 0,
    width: "100%"
  }, children: [enableGlobalFilter && positionGlobalFilter === "left" && (0, import_jsx_runtime55.jsx)(MRT_GlobalFilterTextField, Object.assign({}, globalFilterProps)), (_a = renderTopToolbarCustomActions === null || renderTopToolbarCustomActions === void 0 ? void 0 : renderTopToolbarCustomActions({ table })) !== null && _a !== void 0 ? _a : (0, import_jsx_runtime55.jsx)("span", {}), enableToolbarInternalActions ? (0, import_jsx_runtime55.jsxs)(Box_default, { sx: {
    alignItems: "center",
    display: "flex",
    flexWrap: "wrap-reverse",
    gap: "0.5rem",
    justifyContent: "flex-end"
  }, children: [enableGlobalFilter && positionGlobalFilter === "right" && (0, import_jsx_runtime55.jsx)(MRT_GlobalFilterTextField, Object.assign({}, globalFilterProps)), (0, import_jsx_runtime55.jsx)(MRT_ToolbarInternalButtons, { table })] }) : enableGlobalFilter && positionGlobalFilter === "right" && (0, import_jsx_runtime55.jsx)(MRT_GlobalFilterTextField, Object.assign({}, globalFilterProps))] }), enablePagination && ["both", "top"].includes(positionPagination !== null && positionPagination !== void 0 ? positionPagination : "") && (0, import_jsx_runtime55.jsx)(MRT_TablePagination, { position: "top", table }), (0, import_jsx_runtime55.jsx)(MRT_LinearProgressBar, { isTopToolbar: true, table })] }));
};
var MRT_TablePaper = (_a) => {
  ...
  const theme = useTheme();
  return (0, import_jsx_runtime55.jsxs)(Paper_default, Object.assign({ elevation: 2, onKeyDown: (e) => e.key === "Escape" && table.setIsFullScreen(false) }, paperProps, { ref: (ref) => {
  ...
  } : {}), paperProps === null || paperProps === void 0 ? void 0 : paperProps.style), sx: (theme2) => Object.assign({ backgroundColor: baseBackgroundColor, backgroundImage: "unset", overflow: "hidden", transition: "all 100ms ease-in-out" }, parseFromValuesOrFunc(paperProps === null || paperProps === void 0 ? void 0 : paperProps.sx, theme2)), children: [enableTopToolbar && ((_b = parseFromValuesOrFunc(renderTopToolbar, { table })) !== null && _b !== void 0 ? _b : (0, import_jsx_runtime55.jsx)(MRT_TopToolbar, { table })), (0, import_jsx_runtime55.jsx)(MRT_TableContainer, { table }), enableBottomToolbar && ((_c = parseFromValuesOrFunc(renderBottomToolbar, { table })) !== null && _c !== void 0 ? _c : (0, import_jsx_runtime55.jsx)(MRT_BottomToolbar, { table }))] }));
};
...
var MaterialReactTable = (props) => {
  ...
  return (0, import_jsx_runtime55.jsx)(MRT_TablePaper, { table });
};
export {
  MRT_ActionMenuItem,
  MRT_AggregationFns,
